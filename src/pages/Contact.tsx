...
const Contact: React.FC = () => {
    return (
        <>
            <Seo
                title="Contact Us – Acrylis Ingredient Analyzer"
                description="Have questions, feedback, or suggestions for Acrylis? Get in touch with our team. We'd love to hear from you."
                keywords="contact acrylis, skincare tool feedback, ingredient checker support"
            />
